...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div className='text-stone-500 rounded-full inline-flex text-center gap-2 bg-white px-6 py-1 border border-neutral-500'
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn texts to <span className='text-blue-600'
      initial={{opacity:0}}
      animate={{opacity:1}}
